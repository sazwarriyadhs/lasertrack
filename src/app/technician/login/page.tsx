      ...
      <div className="w-full max-w-md">
        ...
        <Card>
            <CardHeader className="text-center pb-4">
                <CardTitle className="text-2xl">Login Portal Teknisi</CardTitle>
                <CardDescription>Akses tugas dan formulir maintenance Anda.</CardDescription>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                        <Label htmlFor="email">Alamat Email Teknisi</Label>
                        <Input 
                            id="email" 
                            type="email" 
